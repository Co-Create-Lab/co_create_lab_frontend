  ...
  return (
    <>
      <div className="allprojects container-fluid">
        <div className="row ">
          <div className="col-4">
            <div className="allprojectsfilter"></div>
          </div>
          <div className="col-8">
            {projects?.map((project) => {
              return (
                <div key={project._id} className="projectoverview">
                    ...
                    <div className="row ">
                      <div className="col-sm">
                        <svg
                          ...
                          className="bi bi-pencil-square projectoverviewicon"
                          viewBox="0 0 16 16"
                        >
                  ...
                  <div className="container">
                    <div className="row projectdetails_row">
                      <div className="col-sm"></div>
                      <div className="col-sm">
                        <div className="allprojects_categories">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
